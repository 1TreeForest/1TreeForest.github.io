...
I am a fourth-year Ph.D. candidate in Computer Science and Engineering at The Chinese University of Hong Kong, fortunately advised by [Prof. Wei Meng](https://www.cse.cuhk.edu.hk/~wei/). Before joining CUHK, I received my B.Eng. in Cyber Science and Engineering from Sichuan University.
...
- **Web Application Vulnerability Repair via Context-Aware Fault Localization and Directed Differential Fuzzing** ([paper](papers/sp26-SlicePatch.pdf)) ([code](https://github.com/cuhk-seclab/SlicePatch))
